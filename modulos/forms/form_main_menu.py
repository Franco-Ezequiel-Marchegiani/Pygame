...
def init_form_main_menu(dict_form_data: dict):
    ...
    form['btn_jugar'] = Button(x=var.DIMENSION_PANTALLA[0]//2, y=150, text='JUGAR', screen=form.get('screen'), font_path=var.FUENTE_ALAGARD, font_size=30, on_click=cambiar_formulario_on_click, on_click_param='form_start_level')
