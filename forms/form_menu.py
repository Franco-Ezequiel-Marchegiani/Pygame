...
def mostrar_menu(pantalla: pg.Surface, cola_eventos: list[pg.event.Event]) -> str:
    ...
    lista_botones[var.BOTON_HISTORIA]['rectangulo'] = pantalla.blit(lista_botones[var.BOTON_HISTORIA]['superficie'], (125, 275)) #Como 2do parámetro se puede pasar un rectángulo 
    lista_botones[var.BOTON_JUGAR]['rectangulo'] = pantalla.blit(lista_botones[var.BOTON_JUGAR]['superficie'], (125, 115)) #Como 2do parámetro se puede pasar un rectángulo 
    lista_botones[var.BOTON_SALIR]['rectangulo'] = pantalla.blit(lista_botones[var.BOTON_SALIR]['superficie'], (125, 355)) #Como 2do parámetro se puede pasar un rectángulo 
